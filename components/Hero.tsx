...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-[620px] lg:min-h-[640px] xl:min-h-[680px] flex items-center overflow-hidden bg-[#0a0f1d]">
      ...
      <div className="container mx-auto px-6 relative z-20 flex flex-col lg:flex-row items-center justify-between w-full pt-24 pb-10 lg:pt-24 lg:pb-8">
        {/* Text Area */}
        <div className="lg:w-[55%] mb-8 lg:mb-0 text-center lg:text-left animate-in fade-in slide-in-from-left-10 duration-1000">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-[4.5rem] font-black text-white leading-[1.05] mb-6 tracking-tighter">
            결과가 말해주는<br />
            실력의 차이,<br />
          ...
          <div className="max-w-xl mx-auto lg:mx-0">
            <p className="text-slate-300 text-base md:text-xl lg:text-2xl mb-7 font-medium leading-relaxed border-l-4 border-amber-600 pl-6 text-left">
        ...
        <div className="lg:w-[38%] relative flex items-center justify-center animate-in fade-in slide-in-from-right-10 duration-1000 delay-200">
          <div className="relative w-full max-w-[300px] md:max-w-[360px] lg:max-w-[380px] aspect-[4/5] rounded-[2.5rem] overflow-hidden border-[10px] border-white/5 shadow-2xl bg-slate-800">
